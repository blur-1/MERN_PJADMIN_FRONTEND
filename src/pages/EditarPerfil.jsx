    ...
    <div className='flex justify-center'>
        <div className='w-full md:w-1/2 bg-white shadow rounded-lg p-5'>
            ...
            <form onSubmit={handleSubmit}>
                <div className='my-3'>
                    <label className='uupercase font-bold text-gray-600' htmlFor="">Nombre</label>
                ...
                <div className='my-3'>
                    <label className='uupercase font-bold text-gray-600' htmlFor="">Celular</label>
                    <input type="text" className='border bg-gray-50 w-full p-2 mt-5 rounded-lg'
                         name="telefono"
                ...
                <div className='my-3'>
                    <label className='uupercase font-bold text-gray-600' htmlFor="">Email</label>
                    <input type="text" className='border bg-gray-50 w-full p-2 mt-5 rounded-lg'
                        name="email"
                        value={perfil.email|| ""}
                        onChange={e=>setPerfil({...perfil,[e.target.name] : e.target.value})}
